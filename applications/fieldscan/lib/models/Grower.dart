...
/** This is an auto generated class representing the Grower type in your schema. */
@immutable
class Grower extends Model {
  static const classType = const _GrowerModelType();
  final String id;
  final String? _name;
  ...
  GrowerModelIdentifier get modelIdentifier {
      return GrowerModelIdentifier(
        id: id
      );
  }
...
class _GrowerModelType extends ModelType<Grower> {
  const _GrowerModelType();
  
  @override
  Grower fromJson(Map<String, dynamic> jsonData) {
    return Grower.fromJson(jsonData);
  }
 ...
 * of [Grower] in your schema.
 */
@immutable
class GrowerModelIdentifier implements ModelIdentifier<Grower> {
  final String id;

  /** Create an instance of GrowerModelIdentifier using [id] the primary key. */
  const GrowerModelIdentifier({
    required this.id});
  ...
  @override
  String toString() => 'GrowerModelIdentifier(id: $id)';
  ...
  bool operator ==(Object other) {
    ...
    return other is GrowerModelIdentifier &&
      id == other.id;
  }
