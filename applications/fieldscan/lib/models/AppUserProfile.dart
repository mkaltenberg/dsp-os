...
/** This is an auto generated class representing the AppUserProfile type in your schema. */
@immutable
class AppUserProfile extends Model {
  ...
  AppUserProfileModelIdentifier get modelIdentifier {
      return AppUserProfileModelIdentifier(
        id: id
      );
  }
...
class _AppUserProfileModelType extends ModelType<AppUserProfile> {
  const _AppUserProfileModelType();
  
  @override
  AppUserProfile fromJson(Map<String, dynamic> jsonData) {
    return AppUserProfile.fromJson(jsonData);
  }
 ...
 * of [AppUserProfile] in your schema.
 */
@immutable
class AppUserProfileModelIdentifier implements ModelIdentifier<AppUserProfile> {
  final String id;

  /** Create an instance of AppUserProfileModelIdentifier using [id] the primary key. */
  const AppUserProfileModelIdentifier({
    required this.id});
  ...
  @override
  String toString() => 'AppUserProfileModelIdentifier(id: $id)';
  ...
  bool operator ==(Object other) {
    ...
    return other is AppUserProfileModelIdentifier &&
      id == other.id;
  }
